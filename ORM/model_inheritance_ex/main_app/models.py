...
class StudentIDField(models.PositiveIntegerField):
    ...
    def get_prep_value(self, value):
        ...
        if cleaned_value <= 0:
            raise ValidationError("ID cannot be less than or equal to zeroID cannot be less than or equal to zero")
...
class MaskedCreditCardField(models.CharField):
    ...
    def __init__(self, *args, **kwargs):
        # Ensure max_length is set to 19 (****-****-****-1234)
        kwargs['max_length'] = 19
        super().__init__(*args, **kwargs)

    def get_prep_value(self, value):
        # Prepare the value before saving to the database
        return self.mask_card_number(value)

    def from_db_value(self, value, expression, connection):
        # No conversion needed when loading from the database
        return value
    ...
    def to_python(self, value):
        ...
        if isinstance(value, str):
            self.validate_card_number(value)
            return value
